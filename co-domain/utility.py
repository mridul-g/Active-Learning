...
def image_normalize(image, dataset):
    ...
    elif dataset in ['MNIST', 'SVHN', 'FashionMNIST']:
        return image
    else:
        print('I am here')
        print(dataset)
